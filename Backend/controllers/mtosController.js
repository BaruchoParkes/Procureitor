...
let mtosController = {
  ...
  store: function (req,res){
    let info = req.body;
    console.log(info)
    db.Mtos.create({proc: req.body.proc, descripcion: req.body.descripcion})
    .then(function(mto){
    res.send(mto)
    } )
    .catch(function(e){
  ...
  update: function(req, res, next){
    ...
    db.Mtos.update({descripcion: req.body.descripcion, fechaDeRealizacion: req.body.fechaDeRealizacion, realizado: req.body.realizado, texto: req.body.texto, Responsable: req.body.Responsable}, {where: {mtoId: req.body.id}})
