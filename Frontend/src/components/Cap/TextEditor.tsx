...
export const TextEditor = ({
  ...
  useEffect(() => {
    ...
    const initialContent = new Delta()
      ...
      .insert(
        '\nDr. CRISTIAN ANDRES PARKES, abogado inscripto al Tº 115 F° 831 CPACF, CUIT 20-29006501-2, IVA Responsable Inscripto, en mi carácter de Letrado apoderado de la parte Actora, en los autos ' +
          autos +
